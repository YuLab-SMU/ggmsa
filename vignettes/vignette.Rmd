...
```
If you specify the full length of the sequence, the letters will not be printed.
```{r fig.height = 2, fig.width = 10, warning=FALSE}
#ggmsa(sequences, color = "Chemistry_AA")
```
#Cross-link with other packages
ggmsa is based on ggplot2, so this package can applied to different scenarios.
