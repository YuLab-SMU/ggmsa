...
```{r fig.height = 2, fig.width = 10, dpi=330}
library(ggmsa)
library(ggplot2)
...
```{r fig.height = 6, fig.width = 13, dpi=330}
...
ggmsa also enable to align MSA graphs to the tree with rectangular layout by linking [ggtreeExtra](https://github.com/YuLab-SMU/ggtreeExtra)(ver >= 1.1.3.991).

```{r fig.height=11, fig.width =11, message=FALSE, dpi=600, out.width="85%"}
library(ggplot2)
library(ggtree)
library(ggtreeExtra)
library(Biostrings)
